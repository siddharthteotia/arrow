...
public class NullableSmallIntVector extends BaseNullableFixedWidthVector {
   private static final org.slf4j.Logger logger =
           org.slf4j.LoggerFactory.getLogger(NullableSmallIntVector.class);
   ...
   public void set(int index, int isSet, short valueField ) {
      if (isSet > 0) {
   ...
   public void setSafe(int index, int isSet, short valueField ) {
      handleSafe(index);
