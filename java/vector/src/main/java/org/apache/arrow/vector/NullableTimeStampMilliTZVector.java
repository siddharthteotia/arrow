 ...
 */
public class NullableTimeStampMilliTZVector extends BaseNullableFixedWidthVector {
   private static final org.slf4j.Logger logger =
           org.slf4j.LoggerFactory.getLogger(NullableTimeStampMilliTZVector.class);
   ...
   public void copyFrom(int fromIndex, int thisIndex, NullableTimeStampMilliTZVector from) {
      if (from.isSet(fromIndex) != 0) {
         set(thisIndex, from.get(fromIndex));
      }
   }

   public void copyFromSafe(int fromIndex, int thisIndex, NullableTimeStampMilliTZVector from) {
   ...
   private class TransferImpl implements TransferPair {
      NullableTimeStampMilliTZVector  to;

      public TransferImpl(String ref, BufferAllocator allocator){
         to = new NullableTimeStampMilliTZVector (ref, field.getFieldType(), allocator);
      }

      public TransferImpl(NullableTimeStampMilliTZVector to){
         this.to = to;
      }
      ...
      public void copyValueSafe(int fromIndex, int toIndex) {
         to.copyFromSafe(fromIndex, toIndex, NullableTimeStampMilliTZVector.this);
      }
   }
}