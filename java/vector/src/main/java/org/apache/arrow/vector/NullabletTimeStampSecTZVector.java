 ...
 */
public class NullableTimeStampSecTZVector extends BaseNullableFixedWidthVector {
   private static final org.slf4j.Logger logger =
           org.slf4j.LoggerFactory.getLogger(NullableTimeStampSecTZVector.class);
   ...
   public void copyFrom(int fromIndex, int thisIndex, NullableTimeStampSecTZVector from) {
      if (from.isSet(fromIndex) != 0) {
         set(thisIndex, from.get(fromIndex));
      }
   }

   public void copyFromSafe(int fromIndex, int thisIndex, NullableTimeStampSecTZVector from) {
   ...
   private class TransferImpl implements TransferPair {
      NullableTimeStampSecTZVector  to;

      public TransferImpl(String ref, BufferAllocator allocator){
         to = new NullableTimeStampSecTZVector (ref, field.getFieldType(), allocator);
      }

      public TransferImpl(NullableTimeStampSecTZVector to){
         this.to = to;
      }

      @Override
      public NullableTimeStampSecTZVector  getTo(){
         return to;
      }
      ...
      public void copyValueSafe(int fromIndex, int toIndex) {
         to.copyFromSafe(fromIndex, toIndex, NullableTimeStampSecTZVector.this);
      }
   }
}