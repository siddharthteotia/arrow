 ...
 */
public class NullableTimeStampNanoVector extends BaseNullableFixedWidthVector {
   private static final org.slf4j.Logger logger =
           org.slf4j.LoggerFactory.getLogger(NullableTimeStampNanoVector.class);
   ...
   public void copyFrom(int fromIndex, int thisIndex, NullableTimeStampNanoVector from) {
      if (from.isSet(fromIndex) != 0) {
         set(thisIndex, from.get(fromIndex));
      }
   }

   public void copyFromSafe(int fromIndex, int thisIndex, NullableTimeStampNanoVector from) {
   ...
   private class TransferImpl implements TransferPair {
      NullableTimeStampNanoVector  to;

      public TransferImpl(String ref, BufferAllocator allocator){
         to = new NullableTimeStampNanoVector (ref, field.getFieldType(), allocator);
      }

      public TransferImpl(NullableTimeStampNanoVector to){
         this.to = to;
      }

      @Override
      public NullableTimeStampNanoVector  getTo(){
         return to;
      }
      ...
      public void copyValueSafe(int fromIndex, int toIndex) {
         to.copyFromSafe(fromIndex, toIndex, NullableTimeStampNanoVector.this);
      }
   }
}