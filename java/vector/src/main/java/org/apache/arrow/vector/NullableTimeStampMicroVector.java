 ...
 */
public class NullableTimeStampMicroVector extends BaseNullableFixedWidthVector {
   private static final org.slf4j.Logger logger =
           org.slf4j.LoggerFactory.getLogger(NullableTimeStampMicroVector.class);
   ...
   public void copyFrom(int fromIndex, int thisIndex, NullableTimeStampMicroVector from) {
      if (from.isSet(fromIndex) != 0) {
         set(thisIndex, from.get(fromIndex));
      }
   }

   public void copyFromSafe(int fromIndex, int thisIndex, NullableTimeStampMicroVector from) {
   ...
   private class TransferImpl implements TransferPair {
      NullableTimeStampMicroVector  to;

      public TransferImpl(String ref, BufferAllocator allocator){
         to = new NullableTimeStampMicroVector (ref, field.getFieldType(), allocator);
      }

      public TransferImpl(NullableTimeStampMicroVector  to){
         this.to = to;
      }

      @Override
      public NullableTimeStampMicroVector  getTo(){
         return to;
      }
      ...
      public void copyValueSafe(int fromIndex, int toIndex) {
         to.copyFromSafe(fromIndex, toIndex, NullableTimeStampMicroVector.this);
      }
   }
}