 ...
 */
public class NullableTimeStampSecVector extends BaseNullableFixedWidthVector {
   private static final org.slf4j.Logger logger =
           org.slf4j.LoggerFactory.getLogger(NullableTimeStampSecVector.class);
   ...
   private class TransferImpl implements TransferPair {
      NullableTimeStampSecVector  to;

      public TransferImpl(String ref, BufferAllocator allocator){
         to = new NullableTimeStampSecVector (ref, field.getFieldType(), allocator);
      }

      public TransferImpl(NullableTimeStampSecVector to){
         this.to = to;
      }

      @Override
      public NullableTimeStampSecVector  getTo(){
         return to;
      }
      ...
      public void copyValueSafe(int fromIndex, int toIndex) {
         to.copyFromSafe(fromIndex, toIndex, NullableTimeStampSecVector.this);
      }
   }
}